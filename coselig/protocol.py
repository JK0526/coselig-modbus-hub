"""RTU framing for the register subset used by the supplied flow."""
import struct
...
def write(slave: int, register: int, value: int) -> bytes:
    ...
    # 0x05 is preserved from the flow; its hardware meaning is unverified.
...
async def receive(reader):
    """Read exactly one ADU; TCP segmentation is unrelated to RTU framing."""
