...
def entity_base(channel: Mapping[str, object], hub_id: str, *, topic_prefix: str = "sunwave") -> str:
...
def unique_id(channel: Mapping[str, object], hub_id: str) -> str:
    ...
    return f"sunwave_{_part(hub_id)}_{_part(channel['slave'])}_{_part(channel['channel'])}"
...
def discovery_payload(
    ...
    *,
    ...
    payload: dict[str, object] = {
        ...
        "device": {
            "identifiers": [f"sunwave_{_part(hub_id)}_{_part(channel['slave'])}"],
            "name": f"Sunwave {channel['model']} {channel['slave']}",
            "manufacturer": "Sunwave",
...
def availability_message(hub_id: str, online: bool, *, topic_prefix: str = "sunwave") -> tuple[str, str]:
