"""Admin-only WebSocket API used by the Sunwave management panel."""
...
def _entry(hass: HomeAssistant, entry_id: str):
    for entry in hass.config_entries.async_entries(DOMAIN):
        if entry.entry_id == entry_id:
            return entry
    raise ValueError("Sunwave Hub entry not found")
...
@websocket_api.websocket_command(
    {vol.Required("type"): "sunwave_modbus_hub/list"}
)
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "sunwave_modbus_hub/save_channel",
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "sunwave_modbus_hub/remove_channel",
        vol.Required("entry_id"): str,
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "sunwave_modbus_hub/set_polling",
        vol.Required("entry_id"): str,
